    ...
    for index, row in data.iterrows():
        ...
        before_query_item_cnt = len(tmp[(tmp['item_id'] == row['item_id']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                                ...
                                                tmp['day'] <= row['day'])])
        before_query_1_item_cnt = len(tmp[(tmp['item_id'] == row['item_id']) & (tmp['query1'] == row['query1']) & (
                tmp['context_timestamp'] < row['context_timestamp']) & (tmp['day'] <= row['day'])])
        ...
        after_query_item_cnt = len(tmp[(tmp['item_id'] == row['item_id']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                               tmp['context_timestamp'] > row['context_timestamp']) & (
                                               tmp['day'] <= row['day'])])
        after_query_1_item_cnt = len(tmp[(tmp['item_id'] == row['item_id']) & (tmp['query1'] == row['query1']) & (
                tmp['context_timestamp'] > row['context_timestamp']) & (tmp['day'] <= row['day'])])
        ...
        before_query_shop_cnt = len(tmp[(tmp['shop_id'] == row['shop_id']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                                tmp['context_timestamp'] < row['context_timestamp']) & (
                                                tmp['day'] <= row['day'])])
        before_query_1_shop_cnt = len(tmp[(tmp['shop_id'] == row['shop_id']) & (tmp['query1'] == row['query1']) & (
                tmp['context_timestamp'] < row['context_timestamp']) & (tmp['day'] <= row['day'])])
        before_query_all_shop_cnt = len(tmp[(tmp['shop_id'] == row['shop_id']) & (tmp['query'] == row['query']) & (
                tmp['context_timestamp'] < row['context_timestamp']) & (tmp['day'] <= row['day'])])
        after_query_shop_cnt = len(tmp[(tmp['shop_id'] == row['shop_id']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                               tmp['context_timestamp'] > row['context_timestamp']) & (
                                               tmp['day'] <= row['day'])])
        after_query_all_shop_cnt = len(tmp[(tmp['shop_id'] == row['shop_id']) & (tmp['query'] == row['query']) & (
                tmp['context_timestamp'] > row['context_timestamp']) & (tmp['day'] <= row['day'])])
        ...
        before_query_brand_cnt = len(tmp[(tmp['item_brand_id'] == row['item_brand_id']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                                 tmp['context_timestamp'] < row['context_timestamp']) & (
                                                 tmp['day'] <= row['day'])])
        before_query_all_brand_cnt = len(tmp[(tmp['item_brand_id'] == row['item_brand_id']) & (
                tmp['query'] == row['query']) & (tmp['context_timestamp'] < row['context_timestamp']) & (
                                                     tmp['day'] <= row['day'])])
        before_query_1_brand_cnt = len(tmp[(tmp['item_brand_id'] == row['item_brand_id']) & (
                tmp['query1'] == row['query1']) & (tmp['context_timestamp'] < row['context_timestamp']) & (
                                                   tmp['day'] <= row['day'])])
        after_query_brand_cnt = len(tmp[(tmp['item_brand_id'] == row['item_brand_id']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                                tmp['context_timestamp'] > row['context_timestamp']) & (
                                                tmp['day'] <= row['day'])])
        after_query_all_brand_cnt = len(tmp[(tmp['item_brand_id'] == row['item_brand_id']) & (
                tmp['query'] == row['query']) & (tmp['context_timestamp'] > row['context_timestamp']) & (
                                                    tmp['day'] <= row['day'])])
        ...
        before_query_city_cnt = len(tmp[(tmp['item_city_id'] == row['item_city_id']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                                tmp['context_timestamp'] < row['context_timestamp']) & (
                                                tmp['day'] <= row['day'])])
        before_query_all_city_cnt = len(tmp[(tmp['item_city_id'] == row['item_city_id']) & (
                tmp['query'] == row['query']) & (tmp['context_timestamp'] < row['context_timestamp']) & (
                                                    tmp['day'] <= row['day'])])
        before_query_1_city_cnt = len(tmp[(tmp['item_city_id'] == row['item_city_id']) & (
                tmp['query1'] == row['query1']) & (tmp['context_timestamp'] < row['context_timestamp']) & (
                                                  tmp['day'] <= row['day'])])
        after_query_city_cnt = len(tmp[(tmp['item_city_id'] == row['item_city_id']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                               tmp['context_timestamp'] > row['context_timestamp']) & (
                                               tmp['day'] <= row['day'])])
        after_query_all_city_cnt = len(tmp[(tmp['item_city_id'] == row['item_city_id']) & (
                tmp['query'] == row['query']) & (tmp['context_timestamp'] > row['context_timestamp']) & (
                                                   tmp['day'] <= row['day'])])
        ...
        before_query_page_cnt = len(tmp[(tmp['context_page_id'] == row['context_page_id']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                                tmp['context_timestamp'] < row['context_timestamp']) & (
                                                tmp['day'] <= row['day'])])
        before_query_1_page_cnt = len(tmp[(tmp['context_page_id'] == row['context_page_id']) & (
                tmp['query1'] == row['query1']) & (tmp['context_timestamp'] < row['context_timestamp']) & (
                                                  tmp['day'] <= row['day'])])
        before_query_all_page_cnt = len(tmp[(tmp['context_page_id'] == row['context_page_id']) & (
                tmp['query'] == row['query']) & (tmp['context_timestamp'] < row['context_timestamp']) & (
                                                    tmp['day'] <= row['day'])])
        after_query_page_cnt = len(tmp[(tmp['context_page_id'] == row['context_page_id']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                               tmp['context_timestamp'] > row['context_timestamp']) & (
                                               tmp['day'] <= row['day'])])
        after_query_1_page_cnt = len(tmp[(tmp['context_page_id'] == row['context_page_id']) & (
                tmp['query1'] == row['query1']) & (tmp['context_timestamp'] > row['context_timestamp']) & (
                                                 tmp['day'] <= row['day'])])
        ...
        before_query_cate_cnt = len(tmp[(tmp['item_category_list'] == row['item_category_list']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                                tmp['context_timestamp'] < row['context_timestamp']) & (
                                                tmp['day'] <= row['day'])])
        before_query_1_cate_cnt = len(tmp[(tmp['item_category_list'] == row['item_category_list']) & (
                tmp['query1'] == row['query1']) & (tmp['context_timestamp'] < row['context_timestamp']) & (
                                                  tmp['day'] <= row['day'])])
        before_query_all_cate_cnt = len(tmp[(tmp['item_category_list'] == row['item_category_list']) & (
                tmp['query'] == row['query']) & (tmp['context_timestamp'] < row['context_timestamp']) & (
                                                    tmp['day'] <= row['day'])])
        after_query_cate_cnt = len(tmp[(tmp['item_category_list'] == row['item_category_list']) & (
                tmp['predict_category_property'] == row['predict_category_property']) & (
                                               tmp['context_timestamp'] > row['context_timestamp']) & (
                                               tmp['day'] <= row['day'])])
        after_query_1_cate_cnt = len(tmp[(tmp['item_category_list'] == row['item_category_list']) & (
                tmp['query1'] == row['query1']) & (tmp['context_timestamp'] > row['context_timestamp']) & (
                                                 tmp['day'] <= row['day'])])
        ...
        after_diff_query_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['predict_category_property'] != row['predict_category_property'])]))
        after_diff_query_all_cnt = len(
            set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['query'] != row['query'])]))
...
def run_leak_feature(i):
    ...
    for index, row in data.iterrows():
        ...
        before_query_all_rate = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['query'] == row['query'])][
                'query'])) / query_all_cnt
        after_query_all_rate = 1 - before_query_all_rate
        before_query_1_rate = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['query1'] == row['query1'])][
                'query1'])) / query_1_cnt
        after_query_1_rate = 1 - before_query_1_rate
        before_item_rate = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['item_id'] == row['item_id'])][
                'item_id'])) / item_cnt
        after_item_rate = 1 - before_item_rate
        before_shop_rate = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['shop_id'] == row['shop_id'])][
                'shop_id'])) / shop_cnt
        after_shop_rate = 1 - before_shop_rate
        before_brand_rate = len(set(tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (
                tmp['item_brand_id'] == row['item_brand_id'])]['item_brand_id'])) / brand_cnt
        after_brand_rate = 1 - before_brand_rate
        before_city_rate = len(set(
        ...
        before_item_query_all_cnt = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['item_id'] == row['item_id'])]['query']))
        before_item_query_1_cnt = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['item_id'] == row['item_id'])]['query1']))
        after_item_query_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['item_id'] == row['item_id'])][
                'predict_category_property']))
        after_item_query_all_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['item_id'] == row['item_id'])]['query']))
        after_item_query_1_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['item_id'] == row['item_id'])]['query1']))
        before_shop_query_cnt = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['shop_id'] == row['shop_id'])][
                'predict_category_property']))
        before_shop_query_all_cnt = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['shop_id'] == row['shop_id'])]['query']))
        before_shop_query_1_cnt = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['shop_id'] == row['shop_id'])]['query1']))
        after_shop_query_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['shop_id'] == row['shop_id'])][
                'predict_category_property']))
        after_shop_query_all_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['shop_id'] == row['shop_id'])]['query']))
        after_shop_query_1_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['shop_id'] == row['shop_id'])]['query1']))
        before_brand_query_cnt = len(set(tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (
                tmp['item_brand_id'] == row['item_brand_id'])]['predict_category_property']))
        before_brand_query_all_cnt = len(set(tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (
                tmp['item_brand_id'] == row['item_brand_id'])]['query']))
        before_brand_query_1_cnt = len(set(tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (
                tmp['item_brand_id'] == row['item_brand_id'])]['query1']))
        after_brand_query_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['item_brand_id'] == row['item_brand_id'])][
                'predict_category_property']))
        after_brand_query_all_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['item_brand_id'] == row['item_brand_id'])][
                'query']))
        after_brand_query_1_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['item_brand_id'] == row['item_brand_id'])][
                'query1']))
        before_city_query_cnt = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['item_city_id'] == row['item_city_id'])][
                'predict_category_property']))
        before_city_query_all_cnt = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['item_city_id'] == row['item_city_id'])][
                'query']))
        before_city_query_1_cnt = len(set(
            tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (tmp['item_city_id'] == row['item_city_id'])][
                'query1']))
        after_city_query_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['item_city_id'] == row['item_city_id'])][
                'predict_category_property']))
        after_city_query_all_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['item_city_id'] == row['item_city_id'])][
                'query']))
        after_city_query_1_cnt = len(set(
            tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (tmp['item_city_id'] == row['item_city_id'])][
                'query1']))
        before_cate_query_cnt = len(set(tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (
                tmp['item_category_list'] == row['item_category_list'])]['predict_category_property']))
        before_cate_query_all_cnt = len(set(tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (
                tmp['item_category_list'] == row['item_category_list'])]['query']))
        before_cate_query_1_cnt = len(set(tmp[(tmp['context_timestamp'] <= row['context_timestamp']) & (
                tmp['item_category_list'] == row['item_category_list'])]['query1']))
        after_cate_query_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['item_category_list'] == row['item_category_list'])]['predict_category_property']))
        after_cate_query_all_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['item_category_list'] == row['item_category_list'])]['query']))
        after_cate_query_1_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['item_category_list'] == row['item_category_list'])]['query1']))
...
def run_compare_feature(i):
    ...
    for index, row in data.iterrows():
        ...
        before_low_price_cnt = len(set(tmp[(tmp['context_timestamp'] < row['context_timestamp']) & (
                tmp['item_price_level'] < row['item_price_level'])]['item_id']))
        after_low_price_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['item_price_level'] < row['item_price_level'])]['item_id']))
        before_high_sale_cnt = len(set(tmp[(tmp['context_timestamp'] < row['context_timestamp']) & (
                tmp['item_sales_level'] > row['item_sales_level'])]['item_id']))
        after_high_sale_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['item_sales_level'] > row['item_sales_level'])]['item_id']))
        before_high_review_num_cnt = len(set(tmp[(tmp['context_timestamp'] < row['context_timestamp']) & (
                tmp['shop_review_num_level'] > row['shop_review_num_level'])]['shop_id']))
        after_high_review_num_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['shop_review_num_level'] > row['shop_review_num_level'])]['shop_id']))
        before_high_review_positive_cnt = len(set(tmp[(tmp['context_timestamp'] < row['context_timestamp']) & (
                tmp['shop_review_positive_rate'] > row['shop_review_positive_rate'])]['shop_id']))
        after_high_review_positive_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['shop_review_positive_rate'] > row['shop_review_positive_rate'])]['shop_id']))
        before_high_star_level_cnt = len(set(tmp[(tmp['context_timestamp'] < row['context_timestamp']) & (
                tmp['shop_star_level'] > row['shop_star_level'])]['shop_id']))
        after_high_star_level_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['shop_star_level'] > row['shop_star_level'])]['shop_id']))
        before_high_score_service_cnt = len(set(tmp[(tmp['context_timestamp'] < row['context_timestamp']) & (
                tmp['shop_score_service'] > row['shop_score_service'])]['shop_id']))
        after_high_score_service_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['shop_score_service'] > row['shop_score_service'])]['shop_id']))
        before_high_score_delivery_cnt = len(set(tmp[(tmp['context_timestamp'] < row['context_timestamp']) & (
                tmp['shop_score_delivery'] > row['shop_score_delivery'])]['shop_id']))
        after_high_score_delivery_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['shop_score_delivery'] > row['shop_score_delivery'])]['shop_id']))
        before_high_score_description_cnt = len(set(tmp[(tmp['context_timestamp'] < row['context_timestamp']) & (
                tmp['shop_score_description'] > row['shop_score_description'])]['shop_id']))
        after_high_score_description_cnt = len(set(tmp[(tmp['context_timestamp'] > row['context_timestamp']) & (
                tmp['shop_score_description'] > row['shop_score_description'])]['shop_id']))
